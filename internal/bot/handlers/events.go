...
func NewEventHandlers(bot *tele.Bot, cfg *config.Config, logger *zap.Logger, workerPool *workerpool.WorkerPool, meetingService *service.MeetingService, transcriberClient *transcriber.TranscriberClient) *EventHandlers {
